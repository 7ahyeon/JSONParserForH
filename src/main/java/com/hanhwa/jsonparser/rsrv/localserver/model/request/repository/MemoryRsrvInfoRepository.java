package com.hanhwa.jsonparser.rsrv.localserver.model.request.repository;
...
public class MemoryRsrvInfoRepository implements RsrvInfoRepository {
    ...
    private static Map<Long, RsrvRequestInfo> rsrvInfoStore = new HashMap<>();

    @Override // 예약 정보 저장
    public void saveRsrvInfo(long rsrvNo, RsrvRequestInfo rsrvRequestInfo) {
        // 예약 정보 저장
        rsrvInfoStore.put(rsrvNo, rsrvRequestInfo);
    }
    ...
    public RsrvRequestInfo findByNo(long rsrvNo) { // 예약 정보 조회(예약 번호로 찾기)
